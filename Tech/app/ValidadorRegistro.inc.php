...
class ValidadorRegistro
{
    ...
    private function  validar_nombre($conexion, $nombre)
    {
        ...
        if(strlen($nombre) > 24)
        {
            return "El nombre no debe de ocupar mas de 24 caracteres";
        }
        
        if(RepositorioUsuario::nombre_existe($conexion, $nombre))
        {
            return "Este nombre de usuario ya existe, Prueba con otro";
        }
    ...
    private function validar_email($conexion, $email)
    {
        ...
        {
            return "Este email ya existe, Prueba con otro email o <a href='#'>intente recuperar su contraseña</a>";
        }
        return "";
    }
    ...
    private function validar_clave2($clave1, $clave2)
    {
        if(!$this -> variable_iniciada($clave1))
        {
            return "Primero ingresa tu contraseña";
        }
